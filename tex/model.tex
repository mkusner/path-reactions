...
In this section we define a probabilistic model that describes the movement of electrons that define an elementary heterolytic reaction.
...
If the reaction assumptions stated in the previous section hold, then, as stated earlier, there are two types of electron movements that alternate: 
...
We define the function $\fEmbed$ to take in a set of graphs representing each molecule and to compute these node embeddings.
