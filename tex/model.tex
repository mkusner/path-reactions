...
and input molecules into the model have been Kekulized \todo[]{1. is this a proper noun and 2. I hope this has been defined by now!} so that each bond $\Bc$ can be a single bond, double bond, or triple bond.
