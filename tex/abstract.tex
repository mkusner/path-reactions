...
Our model achieves excellent performance on the important subset of LEF reactions of the UPSTO reaction dataset, comparing favorably to the strongest baselines.
