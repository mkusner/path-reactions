...
The first figure in the Appendix shows an example of a reaction with symmetries, where different electron paths produce the same product. % correct despite a different atom sequence.
...
%an electron path as a sequence of edits performed on the reactants graph, 
...
This is done by mapping the molecule to Kekul\'e form, % \todo[]{proper noun or what?},
