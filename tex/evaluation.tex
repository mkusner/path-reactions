...
\begin{center}
 ...
 We make use of the code and pre-trained models provided by \citet{jin2017predicting}, however, for evaluating the Seq2Seq approach as neither code or more fine grained results are available we train up the required models from scratch using the OpenNMT library \citep{2017opennmt}.
}
...
%  \centering
  \begin{tabular}{lllll}
    ...
    Seq2Seq FTS \citep{schwaller2017found} & 81.6 & 86.6 & 88.2  & 89.5 \\
    Seq2Seq \citep{schwaller2017found} & 82.5 & 87.0 & 88.4  & 89.7  \\
    \bottomrule \toprule
