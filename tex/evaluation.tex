...
Figure 1 in the Appendix shows an example of a reaction with many symmetries, where different electron paths produce the same product. % correct despite a different atom sequence.
