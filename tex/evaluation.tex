...
Figure 1 in the supplemental material shows an example of a reaction with many symmetries, where the mechanism may be correct despite a different sequence of atoms.
...
If the ultimate the desired goal is to predict the product molecule rather than the electron path,
