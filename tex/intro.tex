...
In this paper we propose a model to predict approximate reaction mechanisms, as shown on the right-hand side of Figure~\ref{fig:task-overview}, of a particularly important subset of organic reactions.
