...
\cite{fooshee2018deep} & $-$ & \checkmark \\ 
\midrule
...
\end{tabular}
\centering
	\caption{Work on machine learning for reaction prediction, and whether they are end-to-end trainable, and predict the reaction mechanism. \label{table.existing}}
\end{table*}
%\end{minipage}
%\vspace{-4ex}
%}
