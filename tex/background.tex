...
where steps start with electron pairs on a single atom (called a \emph{lone pair}), or with the electrons in an existing bond. 
...
If reactions satisfy the above restrictions, then a chemical reaction can be modelled as pairs of electrons moving in a \emph{single path} through the reactant atoms. 
