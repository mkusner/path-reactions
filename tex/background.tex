...
%Reagent molecules, while helping facilitate the reaction, are not involved in this electron movement.
...
%where steps start either with the electron pair on a single atom (called a \emph{lone pair}), or with the electrons in an existing bond. 
...
%Organic reactions are those involving predominantly carbon atoms, which have a large number of applications from drug design to the invention of new materials \citep{segler2018planning}.
