...
However, this combining and then ranking of electron sources and sinks can be a slow process, as many plausible reactions need to be considered. These models also have only so far been successfully trained on small hand-curated datasets.
