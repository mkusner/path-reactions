...
<<<<<<< HEAD
=======
%\todo[]{someone check the chemically accurateness of this.}
>>>>>>> master
...
Then a pair of electrons are removed between a C and O and moved to the O atom, giving rise to the products (step 3). 
