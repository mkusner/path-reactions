...
\end{itemize}
The only other work we are aware of to use machine learning to predict reaction mechanisms are the works \cite{kayala2011learning,kayala2012reactionpredictor,fooshee2018deep}. However, these rely either on complex hand-coded rules and/or hand-curated datasets, which are usually small and proprietary. 
...
% these rely on complex hand-coded rules and expert-annotated datasets, which are usually small and proprietary. More recently, \citet{fooshee2018deep} have also looked into modelling reaction mechanisms. However, for their best results they have only trained on a small hand curated dataset.
