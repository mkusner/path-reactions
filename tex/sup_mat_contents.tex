...
\begin{figure*}[h]
        ...
        \caption{Additional typical selectivity examples: Here, the expected product is shown on the left. The blue arrows indicate the top ranked paths from our model, the red arrows indicate other possibly competing but incorrect steps, which the model does not predict to be of high probability. In all cases, our model predicted the correct products.}
